...
<div class="d-flex justify-content-center">
  <form action="{{ route('users.store') }}" method="POST" class="text-center">
    ...
    <div class="form-row">
      ...
      <div class="col">
        <div class="md-form mb-1">
          <input type="password" id="materialRegisterFormPassword" class="form-control" aria-describedby="materialRegisterFormPasswordHelpBlock" name='ci' value="{{ old('ci') }}" required>
